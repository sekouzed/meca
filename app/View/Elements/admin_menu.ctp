<ul class="menu">
    ...
    <li><?= $this->Html->link('<i class="fa fa-user-secret"></i> '.__('operators'),
            ['controller' => 'operators', 'action' => 'index'],
            ['escape'=>false,'class'=> ($this->params['controller']==='operators')?'active' :'']) ?></li>
    ...
    <li><?= $this->Html->link('<i class="fa fa-users"></i> '.__('users'),
            ['controller' => 'users', 'action' => 'index'],
            ['escape'=>false,'class'=> ($this->params['controller']==='users')?'active' :'']) ?></li>
